 ...
 */
public class SensorMeasureRangeResolver extends MessageResolver {

	public SensorMeasureRangeResolver(byte[] buffer, int length) {
		super(buffer, length);
	...
	public Object parsorMessage() {
		...
		return new SensorMeasureRange(rangs);
	}
